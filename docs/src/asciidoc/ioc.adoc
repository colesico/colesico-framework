...
By default, post produce life cycle listeners invocation is disabled and post construct is enabled.
To change this for a specific instance use _@ListenersControl_ annotation on the producing method
or _@Produce.postProduce/postConstruct_ on default producing declarations.
