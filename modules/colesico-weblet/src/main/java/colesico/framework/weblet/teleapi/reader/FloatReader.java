 ...
 */
@Singleton
public final class FloatReader extends AbstractReader<Float> {
    private final WebletMessages messages;

    @Inject
    public FloatReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, WebletMessages messages) {
        super(routerContextProv, httpContextProv);
        this.messages = messages;
    }

    @Override
    public Float read(WebletTDRContext ctx) {
        try {
