 ...
 */
@Singleton
public final class ByteReader extends AbstractReader<Byte> {
    private final WebletMessages messages;

    @Inject
    public ByteReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, WebletMessages messages) {
        super(routerContextProv, httpContextProv);
        this.messages = messages;
    }

    @Override
    public Byte read(WebletTRContext ctx) {
        try {
