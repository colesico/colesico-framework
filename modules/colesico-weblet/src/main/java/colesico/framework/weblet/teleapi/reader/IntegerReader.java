 ...
 */
@Singleton
public final class IntegerReader extends AbstractReader<Integer> {
    private final WebletMessages messages;

    @Inject
    public IntegerReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, WebletMessages messages) {
        super(routerContextProv, httpContextProv);
        this.messages = messages;
    }

    @Override
    public Integer read(WebletTDRContext ctx) {
        try {
