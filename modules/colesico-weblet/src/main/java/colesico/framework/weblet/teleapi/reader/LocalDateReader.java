 ...
 */
@Singleton
public final class LocalDateReader extends AbstractReader<LocalDate> {
    private static final DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    private final WebletMessages messages;

    @Inject
    public LocalDateReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, WebletMessages messages) {
        super(routerContextProv, httpContextProv);
        this.messages = messages;
    }

    @Override
    public LocalDate read(WebletTDRContext ctx) {
        try {
