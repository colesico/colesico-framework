 ...
 */
@Singleton
public final class LongReader extends AbstractReader<Long> {
    private final WebletMessages messages;

    @Inject
    public LongReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, WebletMessages messages) {
        super(routerContextProv, httpContextProv);
        this.messages = messages;
    }

    @Override
    public Long read(WebletTRContext ctx) {
        try {
