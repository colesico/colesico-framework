...
/**
 * Abstract common transaction manager functionality
 *
 * @param <T> transaction type
 * @param <U> tuning type
 */
abstract public class AbstractTransactionManager<T extends Transaction, U> implements TransactionManager<U> {

    protected final Logger logger;

    protected final ThreadLocal<T> transactions = new ThreadLocal<>();

    public AbstractTransactionManager(Logger logger) {
        this.logger = logger;
    }
