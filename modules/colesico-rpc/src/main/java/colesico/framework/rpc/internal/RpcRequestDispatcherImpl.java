...
public class RpcRequestDispatcherImpl implements RpcRequestDispatcher {
    ...
    protected final Map<String, Map<String, TeleMethod>> invocationPoints = new HashMap<>();
    ...
    protected void loadMethodsMapping(Polysupplier<TeleFacade> teleFacadeSupp) {
        ...
        while (it.hasNext()) {
            ...
            Map<String, TeleMethod> classMethods = invocationPoints.get(ligature.getClassName());
            if (classMethods == null) {
                classMethods = new HashMap<>();
                invocationPoints.put(ligature.getClassName(), classMethods);
            }
    ...
    public void dispatch(String className, String methodName) {
        try {
            Map<String, TeleMethod> classMethods = invocationPoints.get(className);
            if (classMethods == null) {
