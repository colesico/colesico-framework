...
public class RpcTeleFacadeElement extends TeleFacadeElement {
    ...
    public RpcTeleFacadeElement(Class<?> teleType, Class<? extends TeleController2> teleDriverClass, Class<? extends DataPort> dataPortClass, Class<?> ligatureClass, IocQualifier iocQualifier, RpcServiceElement rpcService) {
