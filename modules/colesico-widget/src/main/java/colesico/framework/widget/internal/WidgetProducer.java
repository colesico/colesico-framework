...
import colesico.framework.widget.internal.CompositePageProvider;
import colesico.framework.widget.internal.WidgetKitImpl;
...
public class WidgetProducer {
    ...
    @Singleton
    public WidgetKit provideWidgetKit(WidgetKitImpl impl) {
        return impl;
    }


    public CompositePage provideContentsCollector(CompositePageProvider prov) {
        return prov.get();
    }
