...
/**
 * Analogue of {@link FieldChain} except current value passed toPosition extractor as {@link Optional}
 * This allows null safe access toPosition nested fields : o->o.map(t->t.getA()).map(a->a.getB()).map(b->b.getC())...
 *
