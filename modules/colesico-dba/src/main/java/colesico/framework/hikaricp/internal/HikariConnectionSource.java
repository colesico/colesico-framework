 ...
 */
@Unscoped
public final class HikariConnectionSource implements ConnectionSource {

    protected final Logger log = LoggerFactory.getLogger(HikariConnectionSource.class);
    protected final HikariDataSource dataSource;
    protected final String configClass;

    public HikariConnectionSource(@Message HikariPoolConfig configuration) {
