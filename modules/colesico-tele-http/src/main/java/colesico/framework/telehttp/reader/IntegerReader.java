 ...
 */
@Singleton
public final class IntegerReader extends OriginReader<Integer, TeleHttpReadOptions> {

    private final Messages messages;

    @Inject
    public IntegerReader(OriginFactory originFactory, Messages messages) {
        super(originFactory);
        this.messages = messages;
    }

    @Override
    public Integer read(Class<Integer> baseType, TeleHttpReadOptions options) {
        try {
