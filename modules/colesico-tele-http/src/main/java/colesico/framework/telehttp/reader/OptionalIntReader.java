 ...
 */
@Singleton
public final class OptionalIntReader extends OriginReader<OptionalInt, TeleHttpReadOptions> {
    ...
    @Override
    public OptionalInt read(Class<OptionalInt> baseType, TeleHttpReadOptions options) {
        try {
