 ...
 */
@Singleton
public final class LocalTimeReader extends OriginReader<LocalTime, HttpReadOptions> {
    ...
    @Override
    public LocalTime read(Class<LocalTime> valueType, HttpReadOptions options) {
        try {
