...
import colesico.framework.security.assist.authentication.basic.BasicClient;
...
@Singleton
public class HttpBasicClient implements BasicClient {
    ...
    public HttpBasicClient(Provider<HttpContext> httpContext) {
