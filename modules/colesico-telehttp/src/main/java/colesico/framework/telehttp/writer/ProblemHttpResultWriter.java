...
@Singleton
public class ProblemHttpResultWriter<R extends ProblemHttpResult<?>, O extends HttpWriteOptions>
        extends HttpResultWriter<R, O> {

    public ProblemHttpResultWriter(Provider<HttpResponse> httpResponse) {
        super(httpResponse);
    }
