...
import colesico.framework.telehttp.internal.objectreader.DefaultObjectReader;
...
@Produce(DefaultObjectReader.class)
...
public class ReadersProducer {
    ...
    @Singleton
    public ObjectReader getObjectReader(DefaultObjectReader impl) {
        return impl;
    }
