 ...
 */
@Singleton
public final class DoubleReader<C extends HttpTRContext> extends HttpTeleReader<Double, C> {

    private final Messages messages;

    @Inject
    public DoubleReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, Messages messages) {
