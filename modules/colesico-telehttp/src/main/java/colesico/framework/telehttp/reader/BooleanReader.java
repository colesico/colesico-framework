 ...
 */
@Singleton
public final class BooleanReader extends OriginReader<Boolean, HttpReadOptions> {
    ...
    @Override
    public Boolean read(HttpReadOptions options) {
        try {
            ...
            throw new TeleException(messages.invalidBooleanFormat(options.paramName()));
        }
    }
