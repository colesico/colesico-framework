...
public class BytesResult extends AbstractValueResult<byte[]> {
    ...
    public static class Builder extends AbstractValueResult.Builder<byte[], BytesResult, BytesResult.Builder> {
