 ...
 */
@Singleton
public final class LongReader<C extends HttpTRContext> extends HttpTeleReader<Long, C> {

    private final Messages messages;

    @Inject
    public LongReader(Provider<RouterContext> routerContextProv, Provider<HttpContext> httpContextProv, Messages messages) {
