...
public class ModulatorManager {
    ...
    public void notifyInitTeleFacade(ServiceElement service) {
        for (Modulator modulator : modulators) {
            modulator.onInitTeleService(service);
        }
    }

    public void notifyBeforeParseTeleService(TeleServiceElement teleService) {
        for (Modulator modulator : modulators) {
            modulator.onBeforeParseTeleService(teleService);
        }
    }
    ...
    public void notifyTeleParameterParsed(TeleParameterElement teleParam) {
        for (Modulator modulator : modulators) {
            modulator.onTeleParameterParsed(teleParam);
        }
    }
    ...
    public void notifyTeleFacadeParsed(TeleServiceElement teleService) {
        for (Modulator modulator : modulators) {
            modulator.onTeleServiceParsed(teleService);
        }
    }
